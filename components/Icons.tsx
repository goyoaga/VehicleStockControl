...
export const CarIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    ...
    <path fillRule="evenodd" d="M22.5 15a.75.75 0 0 0-.75-.75H2.25a.75.75 0 0 0-.75.75v.063c.24.05.486.093.738.128a21.46 21.46 0 0 0 3.998.306A2.25 2.25 0 0 1 8.25 18c0 .843-.466 1.57-1.157 1.972.06.015.12.03.18.044a22.502 22.502 0 0 1 8.453 0c.06-.014.12-.029.18-.044A2.25 2.25 0 0 1 15.75 18a2.25 2.25 0 0 1 2.014-2.438c1.383-.1 2.733-.209 3.998-.306.252-.035.5-.078.738-.128V15Zm-10.5 4.5a.75.75 0 0 0 0-1.5H8.25a.75.75 0 0 0 0 1.5h3.75Zm3.75 0a.75.75 0 0 0 0-1.5h-.75a.75.75 0 0 0 0 1.5h.75Z" clipRule="evenodd" />
  </svg>
);
...
export const UserPlusIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0ZM3.375 19.5a5.25 5.25 0 0 1 10.5 0v.003Z" />
    </svg>
);
...
export const LockOpenIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 10.5v2.25" />
    </svg>
);

export const BuildingOfficeIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6.75h1.5m-1.5 3h1.5m-1.5 3h1.5M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 21h18M12 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5M12 6.75v.008c0 .005.001.008.001.008v.008" />
    </svg>
);

export const Square2StackIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
